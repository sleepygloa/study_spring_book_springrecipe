package recipe5_2_11.com.pojo.shop;
...
//		ApplicationContext context2 = new AnnotationConfigApplicationContext(ShopConfiguration.class);
//		
//		String alert = context2.getMessage("alert.checkout",  null, Locale.US);
//		String alert_inventory = context2.getMessage("alert.inventory.checkout", new Object[] {"[DVD-RW 3.0]", new Date()}, Locale.US);
//		
